...
public final class Constants {
	...
	public static final ThingTypeUID BRIDGE_TYPE_ID_WMBUSBRIDGE_UID = new ThingTypeUID(BINDING_ID, BRIDGE_TYPE_ID_WMBUSBRIDGE);
	public static final ThingTypeUID BRIDGE_TYPE_ID_WMBUSVIRTUALBRIDGE_UID = new ThingTypeUID(BINDING_ID, BRIDGE_TYPE_ID_WMBUSVIRTUALBRIDGE);
	public static final ThingTypeUID THING_TYPE_ID_ENCRYPTED_METER_UID = new ThingTypeUID(BINDING_ID, THING_TYPE_ID_ENCRYPTED_METER);
	public static final ThingTypeUID THING_TYPE_ID_ITRON_SMOKE_DETECTOR_UID = new ThingTypeUID(BINDING_ID, THING_TYPE_ID_ITRON_SMOKE_DETECTOR);
	public static final ThingTypeUID THING_TYPE_ID_METER_UID = new ThingTypeUID(BINDING_ID, THING_TYPE_ID_METER);
	public static final ThingTypeUID THING_TYPE_ID_TECHEM_HKV45_UID = new ThingTypeUID(BINDING_ID, THING_TYPE_ID_TECHEM_HKV45);
	public static final ThingTypeUID THING_TYPE_ID_TECHEM_HKV61_UID = new ThingTypeUID(BINDING_ID, THING_TYPE_ID_TECHEM_HKV61);
	public static final ThingTypeUID THING_TYPE_ID_TECHEM_HKV64_UID = new ThingTypeUID(BINDING_ID, THING_TYPE_ID_TECHEM_HKV64);
	public static final ThingTypeUID THING_TYPE_ID_TECHEM_HKV69_UID = new ThingTypeUID(BINDING_ID, THING_TYPE_ID_TECHEM_HKV69);
	public static final ThingTypeUID THING_TYPE_ID_TECHEM_HKV94_UID = new ThingTypeUID(BINDING_ID, THING_TYPE_ID_TECHEM_HKV94);
	public static final ThingTypeUID THING_TYPE_ID_TECHEM_SD76_UID = new ThingTypeUID(BINDING_ID, THING_TYPE_ID_TECHEM_SD76);
	public static final ThingTypeUID THING_TYPE_ID_TECHEM_WMZ43_UID = new ThingTypeUID(BINDING_ID, THING_TYPE_ID_TECHEM_WMZ43);
	public static final ThingTypeUID THING_TYPE_ID_TECHEM_WZ62_UID = new ThingTypeUID(BINDING_ID, THING_TYPE_ID_TECHEM_WZ62);
	public static final ThingTypeUID THING_TYPE_ID_TECHEM_WZ72_UID = new ThingTypeUID(BINDING_ID, THING_TYPE_ID_TECHEM_WZ72);
