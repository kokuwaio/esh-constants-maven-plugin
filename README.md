...
[![Lint](https://img.shields.io/github/workflow/status/kokuwaio/esh-constants-maven-plugin/Lint?label=Lint)](https://github.com/kokuwaio/esh-constants-maven-plugin/actions/workflows/lint.yaml?label=Lint)
